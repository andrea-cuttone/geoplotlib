...
#geoplotlib.kde(data, bw=[10,10], cmap='hot', method='hist', scaling='lin', cut_below=92, clip_above=99)
geoplotlib.kde(data, bw=[15,15], cmap='hot', method='kde', scaling='lin', cut_below=96, clip_above=96.5, binsize=16)
